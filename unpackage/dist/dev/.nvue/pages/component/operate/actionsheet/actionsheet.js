      ...
      createElementVNode(
        ...
        [
              ...
              (openBlock(true), createElementBlock(
                ...
                renderList($data.vals, (item, index) => {
                  return openBlock(), createElementBlock("u-text", {
                    ...
                    style: normalizeStyle({ color: $props.theme === "dark" ? item.darkColor || $props.itemDarkColor : item.color || $props.itemColor, fontSize: (item.size || $props.itemSize) + "rpx" }),
                    key: index,
                    onClick: ($event) => $options.handleClickItem(index)
                  }, toDisplayString(item[$props.textKey]), 15, ["onClick"]);
                }),
                128
                /* KEYED_FRAGMENT */
              ))
          ...
          $props.isCancel ? (openBlock(), createElementBlock(
            ...
            {
              key: 1,
              style: normalizeStyle({ color: $props.theme === "dark" ? $props.itemDarkColor : $props.itemColor, fontSize: ($props.cancelSize || $props.itemSize) + "rpx" }),
...
const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0$1]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue 组件库/components/firstui/fui-actionsheet/fui-actionsheet.vue"]]);
...
const actionsheet = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue 组件库/pages/component/operate/actionsheet/actionsheet.nvue"]]);
export {
