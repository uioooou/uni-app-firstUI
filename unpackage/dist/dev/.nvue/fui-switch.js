    ...
    [
      $props.type === "switch" ? (openBlock(), createBlock(_component_switch, {
        ...
        "view",
        {
          ...
          style: normalizeStyle({ background: $data.val ? $options.getColor : $props.background, border: $data.val ? `1px solid ${$options.getColor}` : `1px solid ${$props.borderColor}` })
        },
        [
...
const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue 组件库/components/firstui/fui-switch/fui-switch.vue"]]);
export {
  __easycom_0 as _
};
