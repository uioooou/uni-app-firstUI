...
const fuiicons = "/assets/fui-icon.9165208c.ttf";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "u-text",
    {
      ...
      class: normalizeClass(["fui-icon", [$props.customPrefix && $props.customPrefix !== true ? $props.customPrefix : ""]]),
      onClick: _cache[0] || (_cache[0] = (...args) => $options.handleClick && $options.handleClick(...args))
    },
    toDisplayString($props.customPrefix && $props.customPrefix !== true ? $props.name : $data.icons[$props.name]),
    7
    /* TEXT, CLASS, STYLE */
  );
}
const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue 组件库/components/firstui/fui-icon/fui-icon.vue"]]);
export {
  __easycom_1 as _
};
