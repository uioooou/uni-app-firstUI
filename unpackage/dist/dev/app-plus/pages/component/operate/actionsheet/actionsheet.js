...
(() => {
  ...
  // ../../../../../Documents/HBuilderProjects/FirstUI-nvue 组件库/unpackage/dist/dev/.nvue/pages/component/operate/actionsheet/actionsheet.js
        ...
        (0, import_vue3.createElementVNode)(
          ...
          [
                ...
                ((0, import_vue3.openBlock)(true), (0, import_vue3.createElementBlock)(
                  ...
                  (0, import_vue3.renderList)($data.vals, (item, index) => {
                    return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("u-text", {
                      ...
                      style: (0, import_vue3.normalizeStyle)({ color: $props.theme === "dark" ? item.darkColor || $props.itemDarkColor : item.color || $props.itemColor, fontSize: (item.size || $props.itemSize) + "rpx" }),
                      key: index,
                      onClick: ($event) => $options.handleClickItem(index)
                    }, (0, import_vue3.toDisplayString)(item[$props.textKey]), 15, ["onClick"]);
                  }),
                  128
                  /* KEYED_FRAGMENT */
                ))
            ...
            $props.isCancel ? ((0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)(
              ...
              {
                key: 1,
                style: (0, import_vue3.normalizeStyle)({ color: $props.theme === "dark" ? $props.itemDarkColor : $props.itemColor, fontSize: ($props.cancelSize || $props.itemSize) + "rpx" }),
  ...
  var __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0$1]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue \u7EC4\u4EF6\u5E93/components/firstui/fui-actionsheet/fui-actionsheet.vue"]]);
  ...
  var actionsheet = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_02]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue \u7EC4\u4EF6\u5E93/pages/component/operate/actionsheet/actionsheet.nvue"]]);
