...
(() => {
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      "view",
      {
        class: (0, import_vue.normalizeClass)(["fui-button__wrap", [!$options.getWidth || $options.getWidth === "100%" || $options.getWidth === true ? "fui-button__flex-1" : "", $props.disabled && !$props.disabledBackground ? "fui-button__opacity" : ""]]),
        style: (0, import_vue.normalizeStyle)({ width: $options.getWidth, height: $options.getHeight, marginTop: $props.margin[0] || 0, marginRight: $props.margin[1] || 0, marginBottom: $props.margin[2] || $props.margin[0] || 0, marginLeft: $props.margin[3] || $props.margin[1] || 0, borderRadius: $options.getRadius, background: $options.getBackground }),
      ...
      [
        (0, import_vue.createVNode)(_component_button, {
          class: (0, import_vue.normalizeClass)(["fui-button", [
          ...
          scope: $props.scope,
          onClick: (0, import_vue.withModifiers)($options.handleTap, ["stop"])
        }, {
          default: (0, import_vue.withCtx)(() => [
            $props.text ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
              ...
              {
                key: 0,
                class: (0, import_vue.normalizeClass)(["fui-button__text", { "fui-btn__gray-color": !$props.background && !$props.disabledBackground && !$props.plain && $props.type === "gray" && $props.color === "#fff", "fui-text__bold": $props.bold }]),
                style: (0, import_vue.normalizeStyle)({ fontSize: $options.getSize, lineHeight: $options.getSize, color: $options.getColor })
              },
  ...
  // ../../../../../Documents/HBuilderProjects/FirstUI-nvue 组件库/unpackage/dist/dev/.nvue/pages/component/nav/bottomPopup/bottomPopup.js
  ...
  // ../../../../../Documents/HBuilderProjects/FirstUI-nvue 组件库/unpackage/dist/dev/.nvue/fui-icon.js
  ...
  var __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_02]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue \u7EC4\u4EF6\u5E93/components/firstui/fui-icon/fui-icon.vue"]]);
  ...
  var __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main3, [["render", _sfc_render3], ["styles", [_style_03]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue \u7EC4\u4EF6\u5E93/components/firstui/fui-list-cell/fui-list-cell.vue"]]);
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return $data.isShow || !$data.isNvue ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)(
      ...
      {
        key: 0,
        class: (0, import_vue5.normalizeClass)(["fui-bottom__popup-wrap", { "fui-bottom__popwrap-show": $props.show }]),
      ...
      [
        $props.radius ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)(
          "view",
          {
            key: 0,
            class: "fui-bottom__popup-border",
            style: (0, import_vue5.normalizeStyle)({ height: $props.radius + "rpx", background: $props.background })
          },
          null,
          4
          /* STYLE */
        ...
        (0, import_vue5.createElementVNode)(
          ...
          {
            ref: "fui_bp_ani",
            class: (0, import_vue5.normalizeClass)(["fui-bottom__popup", { "fui-bottom__popup-show": $props.show, "fui-bp__safe-weex": $data.iphoneX && $props.safeArea }]),
            style: (0, import_vue5.normalizeStyle)({ borderTopLeftRadius: $props.radius + "rpx", borderTopRightRadius: $props.radius + "rpx", background: $props.background }),
  ...
  function _sfc_render4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_fui_bottom_popup = resolveEasycom((0, import_vue5.resolveDynamicComponent)("fui-bottom-popup"), __easycom_12);
    ...
    return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
      ...
      (0, import_vue5.createElementVNode)("view", { class: "fui-wrap" }, [
        (0, import_vue5.createElementVNode)("view", { class: "fui-page__hd" }, [
          (0, import_vue5.createElementVNode)("u-text", { class: "fui-page__title" }, "BottomPopup"),
          (0, import_vue5.createElementVNode)("u-text", { class: "fui-page__desc" }, "BottomPopup \u5E95\u90E8\u5F39\u51FA\u5C42\uFF0C\u4ECE\u5E95\u90E8\u5F39\u51FA\u7684\u6D6E\u5C42\uFF0C\u5F15\u5BFC\u7528\u6237\u8FDB\u884C\u76F8\u5173\u64CD\u4F5C\u3002")
        ]),
        ...
        (0, import_vue5.createVNode)(_component_fui_bottom_popup, {
          show: $data.show,
  ...
  var bottomPopup = /* @__PURE__ */ _export_sfc(_sfc_main4, [["render", _sfc_render4], ["styles", [_style_04]], ["__file", "C:/Users/ROG G513RW-HF224W/Documents/HBuilderProjects/FirstUI-nvue \u7EC4\u4EF6\u5E93/pages/component/nav/bottomPopup/bottomPopup.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/component/nav/bottomPopup/bottomPopup";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    bottomPopup.mpType = "page";
    const app = Vue.createPageApp(bottomPopup, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...bottomPopup.styles || []]));
    app.mount("#root");
  }
})();
